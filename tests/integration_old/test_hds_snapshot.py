...
class TestHdsMergeSnapshot(object):
    ...
    def setup(
        ...
        self.mock_new_data_rows = [
            {"customerID": "customer_4", "key_id": 4, "city_name": "Vancouver"}
        ]
    ...
    def test_merge_snapshot_hds_with_change(self):
        ...
        expected_rows = [
            {"customerID": "customer_1", "key_id": 1, "city_name": "Toronto"},
            {"customerID": "customer_2", "key_id": 2, "city_name": "Montreal"},
            {"customerID": "customer_3", "key_id": 3, "city_name": "Ottawa"},
            {"customerID": "customer_4", "key_id": 4, "city_name": "Vancouver"},
        ]
    ...
    def clean_up(self):
        ...
        target_table_ref = self.client.dataset(self.target_dataset).table(
            f"{self.target_table_id}_HDS_SNAPSHOT"
        )
