...
from gcp_airflow_foundations.operators.gcp.dlp.dlp_to_datacatalog_taskgroup import schedule_dlp_to_datacatalog_taskgroup, schedule_dlp_to_datacatalog_taskgroup_multiple_tables
...
def load_builder(
    ...
    if dlp_table_config.get_is_on():
        ...
        if hds_table_config:
            dlp_tasks_configs.append({'datastore':'hds',
                                      'project_id':project_id,
                                      'table_id':hds_table_config.table_id,
                                      'dataset_id':dataset_hds_id
                                      })
