...
class OracleToBQDataflowDagBuilder(JdbcToBQDataflowDagBuilder):
    ...
    def create_job_params(
        ...
        **kwargs,
        ...
        if not query_schema:
            schema_query = oracle_helpers.get_table_schema_query(
            ...
            casted_columns = oracle_helpers.cast_columns(
            ...
            if ingestion_type == "FULL":
                ...
                query = oracle_helpers.get_query_for_oracle_load_incremental(
                    table_name, casted_columns, config_params["date_column"], owner, kwargs["ds"], num_backtrack_days
                )
            logging.info(query)
