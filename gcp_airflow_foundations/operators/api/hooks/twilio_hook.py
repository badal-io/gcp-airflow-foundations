...
class TwilioHook(BaseHook):
    ...
    def transform_text_messages(self, text_messages) -> list:
        ...
        for i in text_messages:
            ...
            i["date_created"] = datetime.strptime(
                i["date_created"], "%a, %d %b %Y %H:%M:%S %z"
            ).strftime("%Y-%m-%d %H:%M:%S")
            i["date_sent"] = datetime.strptime(
                i["date_sent"], "%a, %d %b %Y %H:%M:%S %z"
            ).strftime("%Y-%m-%d %H:%M:%S")
            i["date_updated"] = datetime.strptime(
                i["date_updated"], "%a, %d %b %Y %H:%M:%S %z"
            ).strftime("%Y-%m-%d %H:%M:%S")
    ...
    def get_text_messages(self, account_sid, FromDate=None, ToDate=None) -> list:
