...
from gcp_airflow_foundations.base_class.dlp_source_config import (
    DlpSourceConfig,
    PolicyTagConfig,
)
...
MOCK_DLP_DATA = [
    {"customerID": "customer_1", "email": "c1@gmail.com", "city_name": "Toronto"},
    {"customerID": "customer_2", "email": "c2@gmail.com", "city_name": "Montreal"},
    {"customerID": "customer_3", "email": "c3@hotmail.com", "city_name": "Ottawa"},
]
...
class TestDlp(unittest.TestCase):
    ...
    def create_dlp_dag(self, dag, project_id, dataset_id, target_table_id):
        ...
        delete_old_dlp_results_task = dlp_taskgroup.children[
            "dlp_policy_tags.delete_old_dlp_results_test"
        ]
        scan_table_task = dlp_taskgroup.children["dlp_policy_tags.scan_table_test"]
        read_dlp_results_task = dlp_taskgroup.children[
            "dlp_policy_tags.read_dlp_results_test"
        ]
        update_tags_task = dlp_taskgroup.children[
            "dlp_policy_tags.update_bq_policy_tags_test"
        ]
    ...
    def test_dlp(self):
        ...
        self.update_table_schema(
            project_id, dataset_id, table_id, TEST_SCHEMA_WITH_POLICY_TAG_2
        )
