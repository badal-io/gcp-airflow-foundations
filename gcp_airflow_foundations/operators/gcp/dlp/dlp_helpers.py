...
def results_to_bq_policy_tags(project_id, fields, poicy_tag_config: PolicyTagConfig) -> list:
 ...
 """
    ...
    for field in unique["field_name"]:
        tags.append({"name": field, "policy_tags": {'names': [policy_tag_name(fields, project_id, poicy_tag_config)]}})
    return tags
