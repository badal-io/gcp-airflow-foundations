...
dag = DAG(
    "mailgun_validate_csv", start_date=dt.datetime(2021, 10, 21), schedule_interval=None
)
...
wait_for_validation = MailgunValidateSensor(
    task_id="wait_for_validation", mailgun_conn="mailgun_conn", job_id=JOB_ID, dag=dag
)
